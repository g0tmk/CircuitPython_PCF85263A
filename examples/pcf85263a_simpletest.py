# based on the Adafruit_CircuitPython_PCF8563 driver located here:
# https://github.com/adafruit/Adafruit_CircuitPython_PCF8563.git
#
# Simple demo of reading and writing the time for the PCF85263A real-time clock.
...
rtc = pcf85263a.PCF85263A(i2c_bus)
